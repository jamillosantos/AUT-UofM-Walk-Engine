void Set_Walk_Engine_Parameters(byte Robot_Num){
  ...
  WEP[P_Fall_Pitch_Thershold]=0.65; 
  ...
  if (Robot_Num==0){
    ...
    WEP[P_Support_Z_Swing_Gain]=-0.01;              
    ...
    WEP[P_Gyro_Stablizer_Arm_Pitch_Gain]=-0.0001;  //0.001      
